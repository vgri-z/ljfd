        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="单据类型">
              <el-input disabled placeholder="船舶营运证登记" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="事项名称">
              <el-input
                v-model="registerForm.affairsName"
                maxlength="100"
                placeholder="请输入事项名称"
              />
            </el-form-item>
          ...
          <el-col :span="12">
            <el-form-item label="营运证编号">
              <el-input
                v-model="registerForm.certNumber"
                maxlength="100"
...
import { operationRegister } from '../../../../service/main/main'
...
export default {
  ...
  methods: {
    ...
    async save() {
      ...
      //   console.log(valid)
      // })
      const res = await operationRegister(this.registerForm)
      if (res.success) {
        ElMessage({
          message: '操作成功',
          type: 'success'
