...
<script>
import { operationRegisterUpdate } from '../../../../service/main/main'
...
export default {
  ...
  methods: {
    ...
    dataInit() {
      ...
      const { description, affairsName, company, shipName, certNumber } = this.detail
    ...
    async save() {
      ...
      const res = await operationRegisterUpdate(this.registerForm)
      if (res.success) {
        ElMessage({
          message: '操作成功',
          type: 'success'
