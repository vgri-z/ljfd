        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="单据类型">
              <el-input disabled placeholder="船检登记" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
import { inspectRegister } from '../../../../service/main/main'
...
export default {
  ...
  methods: {
    ...
    async save() {
      ...
      //   console.log(valid)
      // })
      const res = await inspectRegister(this.registerForm)
      if (res.success) {
        ElMessage({
          message: '操作成功',
          type: 'success'
